package com.bc.lkh.liukaihua_test.adapter;
...
public class NewsAdapter extends BaseAdapter {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if(view == null){
            ...
            holder.iv_01 = view.findViewById(R.id.iv1);
            holder.iv_02 = view.findViewById(R.id.iv2);
            holder.iv_03 = view.findViewById(R.id.iv3);
            view.setTag(holder);
        }else{
